...
\item Eine Sammellinse bildet einen Gegenstand 4-fach vergrößert reell ab, verschiebt man die Linse gegenüber dem Gegenstand um 1cm, so erhält man ein 5-fach vergrößertes, ebenfalls reelles Bild. Wie groß ist die Brennweite der Sammellinse?
\end{enumerate}
\end{framed}
...
\end{align*}
\item Damit man eine größere Vergrößerung erhält, muss man die Linse zum Gegenstand bewegen. Dadurch kann man auf die beiden Abbildungsmaßstäbe schließen
\begin{align*}
M_T &=-\frac{b}{g} = -4 \\
M_T &= -\frac{b+1}{g-1} = -5
\end{align*}
